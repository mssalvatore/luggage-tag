...
default_text_size = 3.85;
default_line_depth = 0.5;
...
line_1_size=default_text_size;
// Amount of inset or outset for line 1
line_1_depth=default_line_depth;
...
line_2_size=default_text_size;
// Amount of inset or outset for line 2
line_2_depth=default_line_depth;
...
line_3_size=default_text_size;
// Amount of inset or outset for line 3
line_3_depth=default_line_depth;
...
line_4_size=default_text_size;
// Amount of inset or outset for line 3
line_4_depth=default_line_depth;

// Text of line 5
line_5_text="Line 5";
// Font style. See fonts.google.com for options.
line_5_style = "Bold";
// Size of line 5 text, in mm. Zero to disable.
line_5_size=default_text_size;
// Amount of inset or outset for line 5
line_5_depth=default_line_depth;

// Text of line 6
line_6_text="Line 6";
// Font style. See fonts.google.com for options.
line_6_style = "Bold";
// Size of line 6 text, in mm. Zero to disable.
line_6_size=default_text_size;
// Amount of inset or outset for line 6
line_6_depth=default_line_depth;
...
module render_text()
{
    ...
    textHeight = line_1_size + line_2_size + (line_2_size > 0 ? line_spacing : 0) + line_3_size + (line_3_size > 0 ? line_spacing : 0) + line_4_size + (line_4_size > 0 ? line_spacing : 0) + line_5_size + (line_5_size > 0 ? line_spacing : 0) + line_6_size + (line_6_size > 0 ? line_spacing : 0);
    ...
    if (line_2_size > 0)
    {
        ...
        if (line_3_size > 0)
        {
            ...
            echo("line_4_: ", line_4_y, " Font: ",line_4_font);
                ...
                if (line_5_size > 0)
                {
                    line_5_y = line_4_y-line_4_size-line_spacing;
                    line_5_font = str(typeface,(line_5_style != "" ? str(":style=",line_5_style) : ""));
                echo("line_5_: ", line_5_y, " Font: ",line_5_font);
                    translate([textOrigin,line_5_y,tagDepth/2+line_5_depth/2*text_position])
                        color(textColor)
                            linear_extrude(height=line_5_depth, center=true)
                                text($fn=textfn, line_5_text,font=line_5_font, valign=textvalign, halign=text_horizonal_alignment, size=line_5_size);
                    // line 6
                    if (line_6_size > 0)
                    {
                        line_6_y = line_5_y-line_5_size-line_spacing;
                        line_6_font = str(typeface,(line_6_style != "" ? str(":style=",line_6_style) : ""));
                    echo("line_6_: ", line_6_y, " Font: ",line_6_font);
                        translate([textOrigin,line_6_y,tagDepth/2+line_6_depth/2*text_position])
                            color(textColor)
                                linear_extrude(height=line_6_depth, center=true)
                                    text($fn=textfn, line_6_text,font=line_6_font, valign=textvalign, halign=text_horizonal_alignment, size=line_6_size);
                    }       
                }       
            }       
        }
